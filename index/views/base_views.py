...
def intro(request):
    ...
    if keyword == "트렌치코트":
        ...
        return render(request, 'index/data.html', context)
    elif keyword == "short_sleeve_jacket":
        ...
        return render(request, 'index/data.html', context)
    elif keyword == "long_sleeve_jacket":
