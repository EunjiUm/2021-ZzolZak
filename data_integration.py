...
def save_FashionScore(product):
    if product == "trench_coat":
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_trench_coat[period][year[i]]
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_coat[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_padded_jacket[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_military[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_blazer[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_leather_jacket[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_fur_jacket[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_short_sleeve_jacket[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_long_sleeve_jacket[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_shirt[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_blouse[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_neat[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_hoodie[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_sweat_shirt[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_denim_pants[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_mini_skirt[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_skirt[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_slacks[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_short_pants[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_sports_wear[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_leggings[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_sports_shoes[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_sandal[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_heel[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_loafers[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_walker[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_dress[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_back_pack[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_tote_bag[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_clutch_bag[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_shoulder_bag[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
        ...
        for i in range(len(year)):
            reviewDate[i] = FashionScore_seoulstore_eco_bag[period][year[i]]
        copied_list = sorted(reviewDate, reverse=True)
        month_1 = reviewDate.index(copied_list[0]) + 1
        month_2 = reviewDate.index(copied_list[1]) + 1
        month_3 = reviewDate.index(copied_list[2]) + 1
...
def save_Ranking(product):
    if product == "trench_coat":
        Ranking(
            ...
            ranking_score=FashionScore_seoulstore_trench_coat[period][
                              'ranking_score']
        ).save()
    elif product == "coat":
        Ranking(
            ranking_name="코트",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_coat[period]['ranking_score']
        ).save()
    elif product == "padded_jacket":
        Ranking(
            ranking_name="패딩",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_padded_jacket[period][
                              'ranking_score']
        ).save()
    elif product == "military":
        Ranking(
            ranking_name="밀리터리",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_military[period][
                              'ranking_score']
        ).save()
    elif product == "blazer":
        Ranking(
            ranking_name="블레이저",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_blazer[period][
                              'ranking_score']
        ).save()
    elif product == "leather_jacket":
        Ranking(
            ranking_name="레더재킷",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_leather_jacket[period][
                              'ranking_score']
        ).save()
    elif product == "fur_jacket":
        Ranking(
            ranking_name="퍼",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_fur_jacket[period][
                              'ranking_score']
        ).save()
    elif product == "short_sleeve_jacket":
        Ranking(
            ranking_name="반팔 티셔츠",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_short_sleeve_jacket[period][
                              'ranking_score']
        ).save()
    elif product == "long_sleeve_jacket":
        Ranking(
            ranking_name="긴팔 티셔츠",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_long_sleeve_jacket[period][
                              'ranking_score']
        ).save()
    elif product == "shirt":
        Ranking(
            ranking_name="셔츠",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_shirt[period][
                              'ranking_score']
        ).save()
    elif product == "blouse":
        Ranking(
            ranking_name="블라우스",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_blouse[period][
                              'ranking_score']
        ).save()
    elif product == "neat":
        Ranking(
            ranking_name="니트",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_neat[period][
                              'ranking_score']
        ).save()
    elif product == "hoodie":
        Ranking(
            ranking_name="후드",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_hoodie[period][
                              'ranking_score']
        ).save()
    elif product == "sweat_shirt":
        Ranking(
            ranking_name="맨투맨",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_sweat_shirt[period][
                              'ranking_score']
        ).save()
    elif product == "denim_pants":
        Ranking(
            ranking_name="데님팬츠",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_denim_pants[period][
                              'ranking_score']
        ).save()
    elif product == "mini_skirt":
        Ranking(
            ranking_name="미니스커트",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_mini_skirt[period][
                              'ranking_score']
        ).save()
    elif product == "skirt":
        Ranking(
            ranking_name="스커트",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_skirt[period][
                              'ranking_score']
        ).save()
    elif product == "slacks":
        Ranking(
            ranking_name="슬랙스",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_slacks[period][
                              'ranking_score']
        ).save()
    elif product == "short_pants":
        Ranking(
            ranking_name="숏팬츠",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_short_pants[period][
                              'ranking_score']
        ).save()
    elif product == "sports_wear":
        Ranking(
            ranking_name="트레이닝",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_sports_wear[period][
                              'ranking_score']
        ).save()
    elif product == "leggings":
        Ranking(
            ranking_name="레깅스",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_leggings[period][
                              'ranking_score']
        ).save()
    elif product == "sports_shoes":
        Ranking(
            ranking_name="운동화",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_sports_shoes[period][
                              'ranking_score']
        ).save()
    elif product == "sandal":
        Ranking(
            ranking_name="샌들",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_sandal[period][
                              'ranking_score']
        ).save()
    elif product == "heel":
        Ranking(
            ranking_name="힐",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_heel[period][
                              'ranking_score']
        ).save()
    elif product == "loafers":
        Ranking(
            ranking_name="로퍼",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_loafers[period][
                              'ranking_score']
        ).save()
    elif product == "walker":
        Ranking(
            ranking_name="워커",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_walker[period][
                              'ranking_score']
        ).save()
    elif product == "dress":
        Ranking(
            ranking_name="원피스",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_dress[period][
                              'ranking_score']
        ).save()
    elif product == "back_pack":
        Ranking(
            ranking_name="백팩",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_back_pack[period][
                              'ranking_score']
        ).save()
    elif product == "tote_bag":
        Ranking(
            ranking_name="토트백",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_tote_bag[period][
                              'ranking_score']
        ).save()
    elif product == "clutch_bag":
        Ranking(
            ranking_name="클러치",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_clutch_bag[period][
                              'ranking_score']
        ).save()
    elif product == "shoulder_bag":
        Ranking(
            ranking_name="숄더백",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_shoulder_bag[period][
                              'ranking_score']
        ).save()
    elif product == "eco_bag":
        Ranking(
            ranking_name="에코백",
            ranking_img=product + ".jpeg",
            ranking_score=FashionScore_seoulstore_eco_bag[period][
                              'ranking_score']
        ).save()
